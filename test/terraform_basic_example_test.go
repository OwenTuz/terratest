...
func TestTerraformBasicExample(t *testing.T) {
	...
	terraformOptions := terraform.NewTerraformOptionsWithDefaultRetryableErrors(
		...
		"../examples/terraform-basic-example",
	...
	// Enhance the default terraform options with varfiles (Variables to pass to our Terraform code using -var-file
	// options)
	terraformOptions.VarFiles = []string{"varfile.tfvars"}
	// Enhance the default terraform options to disable colors in Terraform commands so its easier to parse stdout/stderr
